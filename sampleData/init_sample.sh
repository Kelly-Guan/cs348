...
cat ./inserts/movies.sql ./inserts/users.sql ./inserts/ratings.sql ./inserts/watched.sql ./inserts/watch_later.sql ./inserts/favourites.sql ./inserts/genres.sql ./inserts/movie_cast.sql ./inserts/user_connections.sql ./inserts/votes.sql > insertsm.sql
